        ...
        {open ? (
          <div className="extend-content">
            ...
            <ul className="box-info box-info-mission-sub">
              ...
              <li>
              <span className="bold-text">2. Communication </span> Un site Web peut servir de plateforme pour
                communiquer des annonces importantes (ex. : un service funèbre),
                des nouvelles de l'Eglise, des changements d'horaires, etc. Cela
                peut être particulièrement utile pour les membres qui ne peuvent
                pas assister régulièrement aux réunions ou pour les personnes
                nouvelles dans la communauté.
              </li>
              <li>
              <span className="bold-text">3. Ressources </span>Le site peut proposer des ressources spirituelles
                telles que des prédications enregistrées ou écrites, des
                éléments de liturgie (prières, confessions de foi, etc.), des
                études bibliques, des articles... Cela peut être utiles pour les
                membres qui souhaitent approfondir leur foi ou se ressourcer.
              </li>
              <li>
              <span className="bold-text"> 4. Contact </span> Donner des informations (contact, responsable de
                groupe, coordonnées) au visiteur, c’est faciliter la
                communication entre les membres de l'Eglise et l’extérieur. Les
                personnes peuvent dès lors poser des questions (culte, baptême,
                mariage, service funèbre) ou exprimer leur intérêt pour votre
                Eglise.
              </li>
              <li>
              <span className="bold-text"> 5. Évangélisation </span> Un site internet de paroisse est un outil
                formidable outil d'évangélisation dès lors qu’il fournit des
                informations sur la foi chrétienne, les conviction de l'Eglise,
                et invite les personnes à participer à la vie d’Eglise. Ne
                dit-il pas finalement comme Jésus à ses contemporains : « Venez
                et voyez » ? (Jn 1,39)
              </li>
              <li>
              <span className="bold-text"> 6. Collecte </span> Pour soutenir les activités de l'Eglise locale, le
                site peut inclure des fonctionnalités pour les dons en ligne.
                Cela permet à ceux qui le souhaitent de contribuer
                financièrement et de manière sécurisée… en quelques clics.
              </li>
              <li>
              <span className="bold-text">7. Gestion du fichier paroissial</span> Un site Web peut également
                inclure des fonctionnalités sécurisées de gestion des membres, permettant
                aux responsables de l'Eglise (Conseil presbytéral, conseil
                paroissial, pasteur, prêtre…) de suivre les adhésions, de gérer
                les listes de diffusion, etc.
              </li>
              <li>
              <span className="bold-text"> 8. Éducation et formation</span> Le site peut être utilisé pour
                partager des informations éducatives sur la foi, des formations,
                des éléments de l'histoire de l'Eglise, des photos, des cartes,
                des vidéos, des musiques, etc.
              </li>
              <li>
              <span className="bold-text"> 9. Interaction </span> sociale Les fonctionnalités de médias sociaux sur
                le site peuvent faciliter l'interaction et le partage en ligne
                entre les membres de la communauté.
              </li>
              <li>
              <span className="bold-text">10. Diffuser</span> le culte Il y a une véritable demande pour la
                diffusion (style visio-conférence) du culte en direct, en replay
                (vidéo à la demande), en podcast (audio numérique). Pensez aux
                paroissiens qui ne peuvent plus se déplacer au temple ou à
                l’église. Si cela nécessite d’investir dans du matériel
                audio-visuel, la meilleure porte d’entrée est déjà d’avoir votre
                site d’Eglise.
              </li>
            </ul>
