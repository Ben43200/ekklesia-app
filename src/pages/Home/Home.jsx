    ...
    return (
        ...
        <main>
            ...
            <div className="box-info">
                <p>
                    Bienvenue sur le site Ekklêsia Web,

                    Nous accompagnons les paroisses dans leur expansion et leur visibilité
                    dans les médias actuels. Nous sommes à l’écoute de leurs besoins
                    personnels.
                </p>
            </div>
            ...
            <div className="grid-container">
                ...
                <div className="box-info">
                    ...
                    <p>Les besoins de votre paroisse
                        nécessitent une visibilité médiatique pour garder le lien avec vos
                        membres dans et en dehors des temps d’églises. Nous sommes convaincus
                        que cette création ou une refonte de ce dernier sera un atout
                        fondamental pour votre paroisse.
                    </p>
                ...
                <div className="box-info">
                    ...
                    <p>
                        ...
                        le qui reflète son histoire sa géographie ses valeurs et la vie de sa
                ...
                <div className="box-info">
                    ...
                    <p>
                        Nous codons votre site de A à Z , nous n’utilisons aucun système tels
                        que wordpress ou elementor (service payant) facilitant a création de
                        sites web mais n’offrant pas toutes les possibilités de créations et
                        diminuant les chances d’optimiser votre site internet. Nous
                        travaillons à ce que votre site internet ait une version écran
                ...
                <div className="box-info">
                    ...
                    <p> Eukklêsia Web est né d’une idée entre un ancien pasteur et un développeur web
                        venant de lancer sa micro entreprise tout deux paroissiens de la paroisse protestante unie du Crestois( Crest
                        ,drôme).
                        Nous avons pour vocation de dynamiser la vie des églises locales à travers ce médium.</p>
